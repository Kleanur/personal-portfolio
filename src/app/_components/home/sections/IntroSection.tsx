	...
	return (
		<SectionCard>
			...
			<div className="h-full w-full flex flex-col lg:flex-row">
				<div className="basis-2/3 p-4 xl:p-8 flex flex-col justify-center gap-5">
					<Header>
						<HandWave /> Hi, I&apos;m <HeaderUnderline>Kevin Li</HeaderUnderline>
					</Header>
					<Text>
					...
					<ul className="list-disc ml-8 -mt-4 text-sm sm:text-base lg:text-lg">
						<li className="mb-1">
							<Text>Full-stack web and mobile development</Text>
						</li>
						<li className="mb-1">
							<Text>Big data and distributed computing</Text>
						</li>
						<li>
							<Text>IoT and connected vehicles</Text>
						</li>
					</ul>
					<Text>
						I built this website using <b>Next.js</b>, <b>React</b>, and <b>Typescript</b> to teach myself about modern React development, and to have a hub to showcase my future projects.
					</Text>
					<Text>
				...
				<div className="flex flex-row lg:flex-col basis-1/3 px-2">
					<div className="m-2 flex flex-row-reverse">
						<span className="lg:mx-auto lg:mt-16 mr-4 my-auto">
							<Stamp src={"/gradportrait-zoomed.jpg"} alt={""} className={"w-[140px] h-[180px] lg:w-[200] lg:h-[260] xl:w-[260px] xl:h-[340px] rotate-3"} />
						</span>
					</div>

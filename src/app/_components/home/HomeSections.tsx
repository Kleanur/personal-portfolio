    ...
    return (
        <SectionCard>
            ...
            <div className="h-full w-full grid grid-cols-2 grid-rows-5">
                <div className="col-span-1 row-span-5 m-2 border-black">
                    <h1 className={`text-5xl ${dm_serif_display.className}`}>
                        Hello World!
                    </h1>
                </div>
                <div className="col-span-1 row-span-2 m-2  border-black">

                </div>
                <div className="col-span-1 row-span-3 m-2  border-black">
